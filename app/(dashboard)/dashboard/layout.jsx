        ...
        <ProtectedRoute>
            <div className="flex h-screen">
                ...
                >
                    ...
                    <p className="mt-12 lg:mt-6 text-[#98A2B3] text-[12px] font-normal uppercase">
                        Menu
                    </p>
                    <nav className="mt-4">
                        <ul>
                            {menuItems.map((item) => (
                                <li key={item.href} className="mb-1">
                                    <Link
                                        href={item.href}
                                        className={`flex items-center gap-2 py-2 px-4 font-medium text-[14px] rounded-lg transition duration-300 ease-in-out hover:bg-[#ECF3FF] hover:text-[#3758F9] ${
                                            pathname === item.href
                                ...
                                <div className="absolute right-0 top-13 w-64 bg-white border border-gray-200 rounded-xl shadow-lg py-3 z-50">
                                    ...
                                    <div className="border-t border-gray-200 mt-2 pt-2">
                                        <button
                                            ...
                                            className=" cursor-pointer flex items-center gap-2 w-full px-4 py-2 hover:bg-gray-50 rounded-md text-red-600 text-sm"
                                        >
